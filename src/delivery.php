  ...
  <section id="heading" class="section">
    <div class="heading">
      <div class="container container--wide">
        <div class="container">
          <div class="heading__content">
            ...
            <p class="page__description">
              Доставка осуществляется курьерами поставщика
              <br>
              или службой курьеров Достависта. Также товар
              <br>
        ...
        <div style="background-image: url('img/page/delivery/heading/background.jpg');" class="heading__background"></div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-3">
            <div class="delivery__step">
              ...
              <p class="delivery__description">
                После подтверждения <br> мы сформируем ваш заказ </p>
              </p>
            </div>
            <!-- /.delivery__step -->
          </div>
              ...
              <div class="card mb-3">
                ...
                <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordionEx">
                  <div class="card-body">
                    ...
                    <br> <br>
                    В этом разделе описаны условия для товаров, которые можно купить. Также некоторые товары, которые продаются на Маркете, доставляются непосредственно продавцами
                    и имеют пометку об этом. Для таких товаров могут быть доступны не все возможности, описанные ниже.
                  </div>
                </div>
